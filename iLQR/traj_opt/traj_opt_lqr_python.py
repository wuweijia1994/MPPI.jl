...
from traj_opt.traj_opt import TrajOpt
from traj_opt.traj_opt_utils import \
        DGD_MAX_ITER, DGD_MAX_LS_ITER, DGD_MAX_GD_ITER, \
        ALPHA, BETA1, BETA2, EPS, \
        traj_distr_kl, traj_distr_kl_alt

#from algorithm_badmm import AlgorithmBADMM
#from algorithm_mdgps import AlgorithmMDGPS
...
class TrajOptLQRPython(object):
    ...
    def __init__(self, hyperparams):
        ...
        self.cons_per_step = TRAJ_OPT_LQR['cons_per_step']
        self._use_prev_distr = TRAJ_OPT_LQR['use_prev_distr']
        self._update_in_bwd_pass = TRAJ_OPT_LQR['update_in_bwd_pass']
